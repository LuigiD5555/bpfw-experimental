            ...
            return EngineResult(
                ...
                steps=[
                    StepResult(
                        ...
                        suggested_actions=[
                            "Use one of: verify, verify_integrity, manifest_write, approve, approvals, start, review, apply, reject, runtime snapshot, wiring check, architecture check, composition check, discover, status"
                        ],
                    )
                ],
            )
