...
from bpfw.integrations.inspector.suggestions.keywords import build_project_vocabulary
...
from bpfw.integrations.inspector.suggestions.learning import get_last_domain_for_origin
