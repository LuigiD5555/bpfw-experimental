...
from bpfw.integrations.inspector.suggestions.keywords.evidence import extract_evidence_from_block
from bpfw.integrations.inspector.suggestions.keywords.models import BlockKeywordProfile, KeywordCandidate, ProjectVocabulary
from bpfw.integrations.inspector.suggestions.keywords.normalizer import build_phrases_from_tokens, normalize_tokens
from bpfw.integrations.inspector.suggestions.keywords.scorer import deduplicate_similar, score_evidence
...
def _build_phrases_from_block(
    ...
    if isinstance(detected, dict):
        ...
        if docstring:
            ...
            from bpfw.integrations.inspector.suggestions.keywords.tokenizer import tokenize_text
