...
from bpfw.integrations.inspector.suggestions.purpose.evidence import extract_evidence_from_block
from bpfw.integrations.inspector.suggestions.purpose.models import BlockKeywordProfile, KeywordCandidate, ProjectVocabulary
from bpfw.integrations.inspector.suggestions.purpose.normalizer import build_phrases_from_tokens, normalize_tokens
from bpfw.integrations.inspector.suggestions.purpose.scorer import deduplicate_similar, score_evidence
...
def _build_phrases_from_block(
    ...
    if isinstance(detected, dict):
        ...
        if docstring:
            ...
            from bpfw.integrations.inspector.suggestions.purpose.tokenizer import tokenize_text
