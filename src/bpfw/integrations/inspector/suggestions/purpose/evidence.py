...
from bpfw.integrations.inspector.suggestions.purpose.models import KeywordEvidence
from bpfw.integrations.inspector.suggestions.purpose.tokenizer import (
    tokenize_identifier,
    tokenize_path,
    tokenize_text,
)
