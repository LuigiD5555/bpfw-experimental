"""Unified CLI for AIOA architecture and catalog authority commands."""

import argparse
from collections.abc import Sequence

from aioa.architecture.catalog_validation import (
    check_entrypoint_implementation_main,
    check_implementation_existence_main,
)
from aioa.architecture.checker import main as check_architecture_main
from aioa.architecture.validate_migration import run_validation as validate_migration_run
from aioa.catalog.authority import (
    lock_catalog_command,
    run_guard,
    run_idle_autolock,
    unlock_catalog_command,
)
from aioa.catalog.status import status_catalog_command
from aioa.execution.executable_catalog import check_executables_main
